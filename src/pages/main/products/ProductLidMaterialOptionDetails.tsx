...
import {Product, ProductColor, ProductLidMaterial} from "../../../data/products/Product";
...
export function ProductLidMaterialOptionDetails() {
    ...
    const [lidMaterial, setLidMaterial] = useState<ProductLidMaterial>()
    ...
    useEffect(() => {
        const update = async () => {
            ...
            if (response) {
                ...
                const lidMaterial = response.result.lidMaterials.find((it: ProductLidMaterial) => it.id === lidMaterialOptionId)
                setLidMaterial(lidMaterial)
            }
            else {
                        ...
                        onClick={(e) => {
                            navigate({
                                ...
                                search: createSearchParams({
                                    productId: productId,
                                    action: "edit",
                                    lidMaterialOptionId: lidMaterialOptionId
                                }).toString()
                            })
                        }}
                >Edit</button>
    ...
    if (!product || !lidMaterialOptionId) {
