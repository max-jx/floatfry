...
import {Product, ProductColor} from "../../../data/products/Product";
...
export function ProductColorOptionDetails() {
    ...
    useEffect(() => {
        const update = async () => {
            ...
            if (response) {
                ...
                const color = response.result.colors.find((it: ProductColor) => it.id === colorOptionId)
                setColor(color)
            }
            else {
